...
#define SYS_ENTER_QUOTACTL 1153
#define SYS_EXIT_QUOTACTL 1152
...
#define SYS_ENTER_INOTIFY_ADD_WATCH 1056
#define SYS_EXIT_INOTIFY_ADD_WATCH 1055
...
#define SYS_ENTER_MKNODAT 902
#define SYS_EXIT_MKNODAT 901
#define SYS_ENTER_MKNOD 900
#define SYS_EXIT_MKNOD 899
...
#define SYS_ENTER_EXECVE 870
#define SYS_EXIT_EXECVE 869
#define SYS_ENTER_EXECVEAT 868
#define SYS_EXIT_EXECVEAT 867
...
#define SYS_ENTER_REBOOT 281
#define SYS_EXIT_REBOOT 280
...
int handle_sys_enter_quotactl(struct trace_event_raw_sys_enter *ctx) {
    __u32 pid, tid;
    if (filter(&pid, &tid))
        return 0;
...
int handle_sys_exit_quotactl(struct trace_event_raw_sys_exit *ctx) {
    __u32 pid, tid;
    if (filter(&pid, &tid))
        return 0;
...
int handle_sys_enter_reboot(struct trace_event_raw_sys_enter *ctx) {
    __u32 pid, tid;
    if (filter(&pid, &tid))
        return 0;
...
int handle_sys_exit_reboot(struct trace_event_raw_sys_exit *ctx) {
    __u32 pid, tid;
    if (filter(&pid, &tid))
        return 0;
